...
function M.setup(config)
  ...
  theme.base = {
    ...
    TSFunction = { fg = c.tan, style = config.function_style },
    TSFuncMacro = { fg = c.soft_yellow },
    TSParameter = { fg = c.light_blue, style = "nocombine" },
    TSParameterReference = { fg = c.light_blue },
    TSMethod = { fg = c.light_gray, style = config.function_style },
    ...
    TSKeyword = { fg = c.ornage, style = config.keyword_style },
